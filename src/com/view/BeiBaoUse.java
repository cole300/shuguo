...
public class BeiBaoUse extends View{
	...
	public BeiBaoUse(Context context, ShuguoActivity activity)
	{
		super(context);
	...
	public void loadSource(Activity activity)
	{
		...
		this.btnConfirm.setNameStyle("使用", Color.BLACK, 20, true);
	}
	/*释放资源*/
	...
	protected void onDraw(Canvas canvas)
	{
		...
		canvas.drawText("物品使用", sx + 30, sy + 44, paint);
		/*标题title*/
		paint.setTextAlign(Paint.Align.CENTER);
		paint.setColor(Color.BLACK);
		paint.setFakeBoldText(true);
		paint.setTextSize(18);
		canvas.drawText("物品介绍", sx + 150, sy + 98, paint);
